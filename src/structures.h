...
typedef struct splateforme{
	...
	int bonus;
#ifdef _EE
} plateforme __attribute__((aligned(64)));
#else
} plateforme;
#endif
...
typedef struct sobj{
	...
	int value;
#ifdef _EE
} objet __attribute__((aligned(64)));
#else
} objet;
#endif
...
typedef struct sechelle{
	...
	int pad_bas_hauteur;
#ifdef _EE
} ladder __attribute__((aligned(64)));
#else
} ladder;
#endif
...
#ifdef _EE
} balle __attribute__((aligned(64)));
#else
} balle;
#endif
...
typedef struct sjoueur{
	...
	int en_descente;
#ifdef _EE
} joueur __attribute__((aligned(64)));
#else
} joueur;
#endif
